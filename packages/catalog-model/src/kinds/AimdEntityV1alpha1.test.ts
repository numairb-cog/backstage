...
import {
  AimdEntityV1alpha1,
  aimdEntityV1alpha1Validator as validator,
} from './AimdEntityV1alpha1';

describe('AimdV1alpha1Validator', () => {
  let entity: AimdEntityV1alpha1;
  ...
  beforeEach(() => {
    entity = {
      ...
      spec: {
        ...
        owner: 'platform-team',
        definition:
          'https://raw.githubusercontent.com/example/repo/main/docs/README.md',
